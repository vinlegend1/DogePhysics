					...
					<div onClick={onClick} className="scroll h-full">
						<div className="container">
							...
							<h2 className="chapter-link">
								...
								>
									<a>
										C {mission.chapterNumber}{" "}
										{mission.chapterName}
									</a>
								</Link>
							</h2>
							<h2 className="mission-description">
								Instructions: {mission.shortDescription}
							</h2>
								...
								<h3 className="go-back-link">
									...
									>
										<a style={{ color: "inherit" }}>
											Go back to C {mission.chapterNumber}{" "}
											{mission.chapterName} to Complete
											Mission
										</a>
									</Link>
								</h3>
